...
export function App(props) {
    ...
    return (
        <div className='container'>
            <div>
                <button style={{ height: "30px", marginLeft: 5, border: "none", outline: "none" }} data-id='add-drag' onPointerDown={onAddDragMouseDown} />
            ...
            <div style={{ position: "relative", flexGrow: 1 }}>
                <Layout ref={selfRef} model={model} factory={factory} />
            </div>
        </div>
    );
}
